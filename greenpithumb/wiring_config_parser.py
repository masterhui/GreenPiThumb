...
_GpioPinConfig = collections.namedtuple('_GpioPinConfig', [
    'pump', 'dht22', 'sonar', 'soil_moisture', 'mcp3008_clk', 'mcp3008_dout',
...
def _validate_gpio_pin_config(gpio_config):
    ...
    used_pins = set()
    for pin in [
            gpio_config.pump, gpio_config.dht22, gpio_config.sonar, gpio_config.mcp3008_clk,
...
def parse(config_data):
    ...
    try:
        ...
        gpio_pin_config = _GpioPinConfig(
            ...
            dht22=_parse_gpio_pin(raw_parser.get('gpio_pins', 'dht22')),
